      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8 backdrop-blur-sm bg-white/80 border border-white/20 shadow-xl rounded-2xl px-6 pt-6">
          <div className="flex items-center justify-between">
            ...
            <button 
              className="group flex items-center justify-center space-x-2 px-6 py-3 text-xs font-medium text-gray-600 hover:text-white bg-white/50 hover:bg-gradient-to-r hover:from-blue-500 hover:to-blue-600 border border-gray-200 hover:border-transparent rounded-xl transition-colors duration-300 shadow-lg shadow-gray-100 hover:shadow-xl transform hover:-translate-y-0.5"
          ...
          <div className="">
            ...
            <div className="relative bg-white px-0 pb-8 mt-8 border-b border-gray-100">
              <div className="relative z-10">
                <div className="flex items-start justify-between mb-0">
                  ...
                  {user?.companyLogo 
                    ? (
                    <img src={user.companyLogo} alt="Company Logo" className="h-16 md:h-20 w-16 md:w-20 object-cover rounded-2xl border-4 border-white/20 shadow-lg" />
                    )
                    : (
                ...
                <div className="flex flex-wrap gap-3 mt-6 md:mt-0">
                  ...
                  <span className="px-4 py-2 bg-purple-50 text-sm text-purple-700 font-semibold rounded-full border border-purple-200">
                    {
                      JOB_TYPES.find((c) => c.value === formData.jobType)?.label
                    }
                  </span>
            ...
            ">
              ...
              <div className="bg-gradient-to-b from-purple-50 to-pink-60 border border-purple-100 rounded-xl p-6 ">
                <div className="text-sm text-gray-700 leading-relaxed whitespace-pre-wrap">
