...
import { Briefcase, Building2, LogOut, Menu, Sidebar, X } from "lucide-react";
...
const DashboardLayout = ({ activeMenu, children }) => {
  ...
  return (
    <div className="flex h-screen bg-gray-50">
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-50 transition-transform duraton-300 tranform ${
          isMobile
            ? sidebarOpen
              ? "translate-x-0"
              : "-translate-x-full"
      ...
      <div 
        ...
        {/* Top navbar */}
        <header className="bg-white/80 backgrop-blur-sm border-b border-gray-200 h-16 flex items-center justify-between px-6 sticky top-0 z-3">
