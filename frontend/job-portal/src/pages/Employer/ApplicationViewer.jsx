...
const ApplicationViewer = () => {
  ...
  const fetchApplications = async () => {
    try {
      setLoading(true);
      const response = await axiosInstance(API_PATHS.APPLICATION.GET_ALL_APPLICATIONS(jobId));
      ...
      {loading && (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="text-center">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-b-blue-600 mx-auto"></div>
                            ...
                            <div className="flex items-center gap-4">
                              ...
                              <div className="shrink-0">
                                {application.applicant.avatar ? (
                                  ...
                                  <div className="h-12 w-12 rounded-full bg-blue-100 items-center justify-center">
