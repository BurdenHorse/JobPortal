...
import { Search, Plus, Edit, ChevronUp, ChevronDown, Users, X, Trash2 } from "lucide-react";
  ...
  const handleStatusChange = async (jobId) => {
    try {
      const response = await axiosInstance.put(
        API_PATHS.JOBS.TOGGLE_JOB(jobId)
      );
      getPostedJobs(true);
    } catch (error) {
          ...
          <div className="mb-8">
            <div className="flex flex-row items-center justify-between">
              ...
              <button
                ...
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-sm text-white font-semibold rounded-xl shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/3 transition-all duration-300 transform hover:-translate-y-0.5 whitespace-nowrap"
              >
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl shadow-black/5 border border-white/20 p-6 mb-8">
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="flex-1 relative">
                <div className="absolute inset-y-0 lef-t0 pl-3 flex items-center pointer-events-none">
                ...
                <div className="w-[75vw] md:w-full overflow-x-auto scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gradient-to-r from-gray-50 to-gray-100/50">
                      <tr>
                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider cursor-pointer hover:bg-gray-100/60 transition-all duration-200 min-w-[200px] sm:min-w-0" onClick={() => handleSort("title")}>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      {isLoading
                        ...
                        : paginatedJobs.map((job) => (
                          <tr
                            key={job.id}
                            className="hover:bg-blue-50/30 transition-all duration-200 border border-gray-100/60"                            
                          >
                            ...
                            <td className="px-6 py-4 whitespace-normal text-sm font-medium min-w-[180px] sm:min-w-0">
                              <div className="flex space-x-2">
                                <button 
