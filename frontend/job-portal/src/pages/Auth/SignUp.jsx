      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <input 
                  ...
                  className="hidden" 
                />
                <label htmlFor="avatar" className="cursor-pointer bg-gray-50 border border-gray-300 rounded-lg px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 transition-colors flex items-center space-2">
          ...
          {formState.errors.submit && (
            <div className="br-red-50 border borer-red-200 rounded-lg p-3">
