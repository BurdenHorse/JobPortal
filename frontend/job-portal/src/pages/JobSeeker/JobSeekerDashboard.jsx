        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 lg:py-8">
          ...
          <div className="flex gap-6 lg:gap-8">
            ...
            <div className="hidden lg:block w-80 shrink-0">
              <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-lg border-rose-50 border-white/20 p-6 sticky top-20">
            ...
            <div className="flex-1 min-w-0">
              ...
              {
                jobs.length === 0 ? (
                  <div className="text-center py-16 lg:py-20 bg-white/60 backdrop-blur-xl rounded-2xl border-white/20 border">
                    <div className="tex-gray-400 mb-6">
