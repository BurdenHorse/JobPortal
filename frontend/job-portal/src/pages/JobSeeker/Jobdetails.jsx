              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  {jobDetails?.applicationStatus ? (
                    ...
                    <button
                      className='bg-gradient-to-br from-blue-50 to-purple-50 text-blue-700 hover:text-white px-6 py-2.5 rounded-xl hover:from-blue-500 hover:to-blue-600 transition-all duration-200 font-semibold transform hover:-translate-y-0.5'
                      onClick={applyToJob}
                    >
                      Apply Now
                    </button>
                  ...
                  <div className="flex items-center space-x-1 px-4 py-2 bg-gray-50 text-sm text-gray-700 font-semibold rounded-full border border-gray-200">
                    ...
                    <span>
                      {jobDetails.createdAt
                        ? moment(jobDetails.createdAt).format("Do MMM YYYY") : "N/A"}
                    </span>
                  </div>
                </div>
              </div>
