      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Whether you're looking for your next opportunity or the perfact
        ...
        <div className="grid md:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            <div className="text-center mb-12">
              ...
              <div className="w-24 h-1 bg-gradient-to-r from-blue-200 to-purple-600 mx-auto rounded-full" />
            </div>
          ...
          <div>
            <div className="text-center mb-12">
              ...
              <div className="w-24 h-1 bg-gradient-to-r from-purple-500 to-blue-200 mx-auto rounded-full" />
            </div>
